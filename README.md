...
<sub>A free Shortcut, then <strong>Share → Lanlord</strong> from Photos or any app, like AirDrop.</sub>
</p>
...
- **Over plain http, files and the passcode cross your network unencrypted.** The cookie a
  ...
  your Wi-Fi traffic could pick it up even if you mostly use the https address. **Forget** on
...
Tailscale for access away from home. See [Security](#security), including its known limits.
